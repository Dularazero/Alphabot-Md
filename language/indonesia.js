...
exports.welcome = () =>{
	return`*● Hi! MpM වෙතට ඔබව සාදරයෙන් පිලිගන්නවා!😘* 

● මෙම සමූහය අපගේ *links* සහ *උපදෙස්* ලබා ගැනීම සදහා සෑදූවකි.
● chat කිරීම සදහා අපගේ Telegram සමූහයට එක් වන්න. »»» t.me/whatsappgang
● ෆිල්ම්ස්/සීරීස් upload කරන්නේ මෙම සමූහයට නොව *වෙනත්* සමූහයන්ටය.
● අප ෆිල්ම්ස් upload කරන්නේ STUDIO groups වලට හා සීරීස් upload කරන්නේ TV SERIES groups වලට වන අතර *එක්* STUDIO group එකක සහ *එක්* TV SERIES group එකක *පමනක්* සිටීමට වග බලාගන්න.
● ඔබට අවශ්‍ය දේ ලබා ගැනීම සදහා admin වරයෙකු mention කරන්න.
● TV SERIES බලන අය *පමනක්* මෙම group එකේ admin කෙනෙක්ගේ inbox පැමින TV SERIES group link එකක් ලබාගන්න. එමෙන්ම එම link එක share *නොකිරීමට* වග බලාගන්න, මන්ද අපේ main STUDIO group වල ඉන්න අයට *විතරයි* ඒ groups හැදුවේ. අපේ main STUDIO groups වල links share කරන්න එය කිසිම ප්‍රශ්නයක් නැත. 

*● ඔබගේ ගැටලුව විසදූ විගස මෙම සමූහයෙන් ඉවත්ව යන්න.*`
}
exports.source = () =>{
return`*── 「 SOURCE 」 ──*
